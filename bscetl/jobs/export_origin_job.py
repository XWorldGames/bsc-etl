...
from bscetl.mappers.origin_mapper import OriginMarketplaceListingMapper, OriginShopProductMapper
from bscetl.service.origin_extractor import OriginEventExtractor
